...
class Pooler(nn.Module):
    ...
    def forward(self, x, boxes):
        """
        Arguments:
            x (list[Tensor]): feature maps for each levelb   
        ...
        assert num_levels == len(x), [num_levels, len(x)]
        ...
        result = result.view(bs, int(num_rois/bs), num_channels, output_size, output_size)
