...
class TensorboardLogger(MetricLogger):
    def __init__(self,
        ...
        self.writer = self._get_tensorboard_writer(log_dir, extra_name)

    @staticmethod
    def _get_tensorboard_writer(log_dir, extra_name):
        try:
        ...
        if is_main_process():
            ...
            tb_logger = SummaryWriter('{}-{}-{}'.format(log_dir, timestamp, extra_name))
            return tb_logger
        else:
            return None
